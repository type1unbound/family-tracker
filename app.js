...
// Make TrackerTemplates globally available
...
const MedicationTracker = {
    ...
    renderSettings: function() {
        ...
        container.innerHTML = `
            <div style="background: #f9fafb; padding: 20px; border-radius: 8px;">
                ...
                <p style="color: #6b7280; margin-bottom: 16px;">Settings and customization options coming soon!</p>
    ...
    deleteAllData: function() {
        if (!confirm('⚠️ Are you sure? This will permanently delete ALL entries for this tracker. This cannot be undone!')) {
            return;
        }
